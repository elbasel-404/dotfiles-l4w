...
- Arch Linux or Fedora-based distribution
...
echo "arch" > ~/.config/ml4w/settings/platform.sh  # or "fedora"
echo "yay" > ~/.config/ml4w/settings/aur.sh       # your AUR helper
```
...
### 5.3 Setup SDDM (Optional Display Manager)
```bash
# Install SDDM
